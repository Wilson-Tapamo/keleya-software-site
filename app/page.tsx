      ...
      <main id="contenu">
        <section className="home-hero">
          ...
          <div className="home-hero-content">
            ...
            <h1>
              <span className="hero-in two">Accélérez votre</span>
              <span className="hero-in three"><span className="hero-keyword hero-performance">performance</span></span>
              <span className="hero-in four hero-phrase">avec <span className="hero-keyword">élégance.</span></span>
            </h1>
        ...
        <section className="precision-section light-section">
          <div className="precision-mark" data-reveal><div className="precision-logo"><span className="precision-logo__disc"><Image src="/keleya-mark-red.png" alt="" width="1600" height="1600" unoptimized /></span><strong>Keleya</strong></div><span>DES IDÉES AUX SYSTÈMES QUI FONT AVANCER</span></div>
