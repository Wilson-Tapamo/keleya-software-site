...
export default function ContactPage() {
  ...
  return <PageShell current="/contact"><main id="contenu">
    ...
    <section className="contact-zone light-section" id="form">
      <div className="contact-info" data-reveal><p className="eyebrow">Commençons simplement</p><h2>Parlons de votre<br /><em>prochain mouvement.</em></h2><p>Quelques lignes suffisent. Aucun jargon nécessaire : dites-nous ce qui vous ralentit aujourd’hui et ce que vous aimeriez rendre possible demain.</p><div className="contact-details"><a href="mailto:contact@keleya.app"><Mail /> <span><small>E-MAIL</small>contact@keleya.app</span></a><a href="tel:+237600000000"><Phone /> <span><small>TÉLÉPHONE</small>+237 600 000 000</span></a><div><MapPin /> <span><small>LOCALISATION</small>Yaoundé, Cameroun</span></div><div><Clock3 /> <span><small>RÉPONSE</small>Sous 1 à 2 jours ouvrés</span></div></div></div>
    ...
    <section className="cta-band"><p className="eyebrow light">Vous préférez écrire directement ?</p><h2 data-reveal>contact@keleya.app</h2><a className="button white" href="mailto:contact@keleya.app">Écrire un e-mail <ArrowUpRight /></a></section>
  </main></PageShell>;
}
